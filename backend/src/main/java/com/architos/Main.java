package com.architos;

import com.architos.customer.Customer;
import com.architos.customer.CustomerRepository;
...
public class Main {
    ...
    private static void createRandomCustomer(CustomerRepository customerRepository, PasswordEncoder passwordEncoder) {
        ...
        String email = firstName.toLowerCase() + "." + lastName.toLowerCase() + "@architos.com";
    ...
    private static void testBucketUploadAndDownload(S3Service s3Service, S3Buckets s3Buckets) {
        ...
        System.out.println("Yay: " + new String(object));
    }
